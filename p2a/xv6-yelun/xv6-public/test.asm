...
main(int argc, char *argv[])
{
  ...
  struct pstat pstat;
  getpinfo(&pstat);
  12:	8d 85 f8 fa ff ff    	lea    -0x508(%ebp),%eax
{
  18:	81 ec 10 05 00 00    	sub    $0x510,%esp
  getpinfo(&pstat);
  1e:	50                   	push   %eax
  1f:	e8 2f 03 00 00       	call   353 <getpinfo>
  uint a = 100;
  
  srand(a);
  24:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  2b:	e8 33 03 00 00       	call   363 <srand>
  int pidA = getpid();
  30:	e8 fe 02 00 00       	call   333 <getpid>
  ...
  37:	6a 14                	push   $0x14
  39:	50                   	push   %eax
  3a:	e8 1c 03 00 00       	call   35b <settickets>
