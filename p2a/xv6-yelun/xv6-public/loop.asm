  ...
  15:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  1d:	51                   	push   %ecx
  1e:	51                   	push   %ecx
  1f:	68 d8 07 00 00       	push   $0x7d8
  24:	6a 01                	push   $0x1
  26:	e8 45 04 00 00       	call   470 <printf>
    exit();
  2b:	e8 d3 02 00 00       	call   303 <exit>
  }

  sleepT = atoi(argv[1]);
  30:	83 ec 0c             	sub    $0xc,%esp
  33:	ff 70 04             	pushl  0x4(%eax)
  36:	e8 55 02 00 00       	call   290 <atoi>

  if (sleepT < 0) {
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	85 c0                	test   %eax,%eax
  40:	78 42                	js     84 <main+0x84>
  ...
  45:	50                   	push   %eax
  46:	e8 48 03 00 00       	call   393 <sleep>
  ...
  5a:	83 c0 01             	add    $0x1,%eax
    j += i * j + 1;
  5d:	0f af ca             	imul   %edx,%ecx
  60:	8d 54 0a 01          	lea    0x1(%edx,%ecx,1),%edx
  while (i < 800000000) {
  64:	3d 00 08 af 2f       	cmp    $0x2faf0800,%eax
  69:	75 ed                	jne    58 <main+0x58>
  }
  int x =i*j;
  6b:	69 d2 00 08 af 2f    	imul   $0x2faf0800,%edx,%edx
  ...
  84:	52                   	push   %edx
  85:	52                   	push   %edx
  86:	68 fc 07 00 00       	push   $0x7fc
  8b:	6a 01                	push   $0x1
  8d:	e8 de 03 00 00       	call   470 <printf>
    exit();
  92:	e8 6c 02 00 00       	call   303 <exit>
  97:	66 90                	xchg   %ax,%ax
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
  9d:	66 90                	xchg   %ax,%ax
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 44 08 00 00 	movzbl 0x844(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 3b 08 00 00       	mov    $0x83b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 645:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 ec 0a 00 00       	mov    %eax,0xaec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 ec 0a 00 00       	mov    0xaec,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 ...
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	bf f0 0a 00 00       	mov    $0xaf0,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 7b6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
